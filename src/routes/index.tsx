...
export const Route = createFileRoute("/")({
  head: () => ({
    ...
    scripts: [
      {
        children: `(function(){try{var h=location.hostname;var dev=h==='localhost'||h==='127.0.0.1'||h.indexOf('id-preview--')===0||h.indexOf('-dev.lovable.app')>-1||h.indexOf('.lovableproject.com')>-1||h.indexOf('.sandbox.lovable.dev')>-1;if(dev)return;var q=new URLSearchParams(location.search);if(q.get('dev')==='1')return;var c=((q.get('utm_campaign')||q.get('campaign')||q.get('utm_campaign_name')||'')+'').toLowerCase();if(c.indexOf('spot')>-1)return;if(q.get('fbclid'))return;location.replace('https://www.tudogostoso.com.br/receita/29124-bolo-simples.html');}catch(e){}})();`,
      },
      {
